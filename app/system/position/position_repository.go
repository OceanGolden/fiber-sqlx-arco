...
type Repository interface {
	...
	FindPage(params *WhereParams) ([]*Position, error)
	FindById(id string) (*Position, error)
	Create(req *Position) error
	Update(req *Position) error
	Delete(req *DeleteRequest) error
	CreateWithTx(req *Position, tx *sqlx.Tx) error
	UpdateWithTx(req *Position, tx *sqlx.Tx) error
	DeleteWithTx(req *DeleteRequest, tx *sqlx.Tx) error
	CheckFields(checkEntity *Position) (*Position, error)
	FindAll(params *WhereParams) ([]*Position, error)
}
...
func (r *repository) FindPage(where *WhereParams) ([]*Position, error) {
...
func (r *repository) FindById(id string) (*Position, error) {
...
func (r *repository) Create(entity *Position) error {
...
func (r *repository) Update(entity *Position) error {
...
func (r *repository) CreateWithTx(entity *Position, db *sqlx.Tx) error {
	insertBuilder := sq.Insert(Table).SetMap(sq.Eq{
		"id":         entity.ID,
		"name":       entity.Name,
		"code":       entity.Code,
...
func (r *repository) UpdateWithTx(entity *Position, db *sqlx.Tx) error {
	found, err := r.FindById(entity.ID)
	if err != nil {
		return errors.New(ErrorNotExist)
	}
...
func (r *repository) CheckFields(checkEntity *Position) (*Position, error) {
...
func (r *repository) FindAll(where *WhereParams) ([]*Position, error) {
	selectBuilder := sq.Select(
		"id",
		"name",
		"code",
